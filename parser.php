...
echo 'строка: ';
print_r($data);
echo 'тип: ' . ($isCat ? 'категория' : 'товар') . '<br>';
if ($isCat) echo "название категории: $catName<br>";
echo 'родитель: ' . ($currentLevels[$level-1] ? $currentLevels[$level-1] : 'корень') . '<br>';
echo '---------<br>';
*/ 

//Проверяем,есть ли такой ресурс на сайте через значение resource_id
